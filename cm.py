...
About Tool:
    ...
    Author : Pushy
    GitHub : https://github.com/dhritzz
    Veesion : 1.0
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : dhritzz.                      \033[94m│".center(columns+14))
    ...
    print("│ \033[95mCoder  : Pushy                   \033[37mV2.0  \033[94m│".center(columns+14))
    print("\033[94m└────────────────────────────────────────┘".center(columns+4))
...
def update():
    ...
    try:
        newVersion = json.loads(sb.getoutput("curl -s \"https://raw.githubusercontent.com/dhritzz/cm/main/.version\"").replace("\n", "").strip())["version"]
    except:
    ...
    if not (oldVersion == newVersion):
        ...
        os.system("cd ../ && rm -rf cm && git clone https://github.com/dhritzz/cm > /dev/null 2>&1")
        psb("\n    [cGreen*cWhite] Update Complete!")
        psb("    [cGreen*cWhite] Starting new Version...")
        os.system("cd ../cm && python cm.py")
    else:
