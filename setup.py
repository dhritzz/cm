...
def install_Ngrok():
    ...
    time.sleep(2)
    if not (chroot == ""):
        os.system("termux-chroot ngrok authtoken 2LlKzyka6CD7xjGKhvdzi75MLjd_3SvA8KpSRdMPw6e2gemwt")
    else:
        os.system("ngrok authtoken 2LlKzyka6CD7xjGKhvdzi75MLjd_3SvA8KpSRdMPw6e2gemwt")
    
    file = open(binPath+"ngtrial.json", "w")
    file.write("{\"auth\": \"2LlKzyka6CD7xjGKhvdzi75MLjd_3SvA8KpSRdMPw6e2gemwt\", \"trialLeft\": 5}")
    file.close()
